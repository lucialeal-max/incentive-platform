...
export const DEMO_PROFILES: Profile[] = [
  { id: "00000000-0000-0000-0000-000000000001", fullName: "Ana García",   email: "ana@demo.com",    isAdmin: true,  jobRole: "RevOps" },
  { id: "00000000-0000-0000-0000-000000000002", fullName: "Carlos López", email: "carlos@demo.com", isAdmin: true,  jobRole: "AE" },
  { id: "00000000-0000-0000-0000-000000000003", fullName: "María Pérez",  email: "maria@demo.com",  isAdmin: false, jobRole: "AE" },
  { id: "00000000-0000-0000-0000-000000000004", fullName: "Juan Torres",  email: "juan@demo.com",   isAdmin: false, jobRole: "SAM" },
  { id: "00000000-0000-0000-0000-000000000005", fullName: "Sofía Ramos",  email: "sofia@demo.com",  isAdmin: false, jobRole: "BDR" },
];

export const DEMO_PLANS: IncentivePlan[] = [
  {
    id: "10000000-0000-0000-0000-000000000001",
    name: "Plan Comercial Q1 2026",
    periodMonth: 3, periodYear: 2026,
    currency: "USD", status: "active", version: 1,
...
export const DEMO_OBJECTIVES: Objective[] = [
  {
    ...
    name: "Bono Sales",
    description: "Deal cerrado con quién tomó la llamada completo y fuera de Red List",
    type: "boolean",
    ...
    routingRules: [
      { condition: { logic: "AND", conditions: [{ field: "deal_source", operator: "eq", value: "AE" }]}, result: "validation", reason: "Deal source AE — requiere revisión" },
  ...
  },
  {
    ...
    description: ">50% usuarios activos, al menos 1 feature sticky y fecha de éxito conocida",
    type: "percentage",
    conditions: { logic: "AND", conditions: [
  ...
  },
  {
    ...
    description: "Alto engagement con CSAT High, >6 procesos resueltos y WAU condicional",
    type: "numeric",
    conditions: { logic: "AND", conditions: [
  ...
  },
  {
    ...
    planId: "10000000-0000-0000-0000-000000000001",
    name: "Bono SQOs",
    description: "Lead con status Validated",
    type: "status",
    ...
    routingRules: [
      ...
      ]}, result: "validation", reason: "Lead en Booked por más de 30 días" },
...
export const DEMO_INSTANCES: ObjectiveInstance[] = [
  {
    ...
    status: "approved",
    conditionResults: [
      { field: "who_got_the_call", passed: true,  actualValue: "Ana García", expectedValue: null,               operator: "known" },
    ...
    bonusAmount: 5000,
    crmSnapshot: { deal_stage: "Won", who_got_the_call: "Ana García", deal_source: "Inbound", mrr: 5000 },
  },
  {
    ...
    bonusAmount: null,
    crmSnapshot: { deal_stage: "Won", deal_source: "AE", mrr: 6000, days_since_booked: 45 },
  },
  {
    ...
    bonusAmount: 500,
    crmSnapshot: { percent_active_users: 72, sticky_feature_count: 2, date_ready_to_success: "2026-02-15" },
  },
  {
    ...
    bonusAmount: null,
    crmSnapshot: { deal_stage: "Won", csat_score: "High", resolved_processes_feature_count: 9, wau_is_stale: true, csat_is_stale: true, mrr: 8000 },
  },
  {
    ...
    bonusAmount: 300,
    crmSnapshot: { lead_status: "Validated" },
  },
];
